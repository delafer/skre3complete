...
#define HOTEND_OFFSET_Z { 0.0, 1.30 }  // (mm) relative Z-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1200, 1000, 100, 5000 }
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 2400, 2000, 200, 10000 } // ...or, set your own edit limits
#endif
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN //use as fallback if normal pin dont work
 ...
 *
 */
//#define Z_MIN_PROBE_PIN PC14 //pins_BTT_SKR_E3_DIP.h
...
#define MIN_SOFTWARE_ENDSTOPS //commented. korvin
